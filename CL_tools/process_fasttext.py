...
# ./fasttext skipgram -dim 512 -input corpus.all.en -output fast_emb/en
WORD2VEC_OPTIONS = 'skipgram'
...
def main():
    ...
    if args.word2vec:
        ...
        cmd = "{w2v} {opts} -input {i} -output {o} -dim {s} " \
            .format(w2v=args.word2vec, opts=WORD2VEC_OPTIONS,
                    i=prep_corpus, o=orig_vectors, s=args.dim_emb)
