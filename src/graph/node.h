...
protected:
  ...
  bool markedForDebugGrad_{false};
...
public:
  ...
  virtual void debug_grad(const std::string& message) override {
    debugMessage_ = message;
    markedForDebugGrad_ = true;
  }

  virtual bool marked_for_debug_grad() override { return markedForDebugGrad_; }
